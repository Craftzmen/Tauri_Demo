                ...
                <nav className='w-full' >
                    ...
                    <div className="flex flex-col w-full" >
                        {sideNavigation.map((navItem) => (
                            <Link key={navItem.id} to={navItem.route} className={` hover:opacity-70 ${currentPath.pathname === navItem.route ? 'bg-indigo-50/50 dark:bg-transparent text-indigo-500 dark:text-white font-medium hover:opacity-100' : 'text-zinc-500/90 dark:text-zinc-400' } flex gap-x-3 items-center px-4 py-2.5 rounded-md transition-all duration-200`} >
